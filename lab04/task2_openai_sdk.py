...
# 使用OpenAI SDK调用API
def call_openai_sdk(system_prompt, user_prompt):
    try:
...
# 主函数
def main():
    print("开始基于OpenAI SDK的智能化需求建模...")
    response = call_openai_sdk(system_prompt, user_prompt)
    save_result(response, "task2_result")
    print("任务2完成")
